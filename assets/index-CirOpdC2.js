...
function Jo(e, t, n) {
  ...
  if (t != null)
    ...
    t))
      Xo.call(t, r) && !Zo.hasOwnProperty(r) && (l[r] = t[r]);
...
function yr(e, t, n, r, l) {
  ...
  if (((i = 0), (r = r === "" ? "." : r + ":"), Mi(e)))
    ...
    for (e = s.call(e), o = 0; !(u = e.next()).done; )
      ((u = u.value), (s = r + wl(u, o++)), (i += yr(u, t, n, s, l)));
  else if (u === "object")
    throw (
      (t = String(e)),
      Error(
      ...
      e: for (var W = 0, X = x.length, qn = X >>> 1; W < qn; ) {
        ...
        if (0 > l(gl, T))
          vt < X && 0 > l(bn, gl)
            ? ((x[W] = bn), (x[vt] = T), (W = vt))
            : ((x[W] = gl), (x[ht] = T), (W = ht));
        else if (vt < X && 0 > l(bn, T)) ((x[W] = bn), (x[vt] = T), (W = vt));
        else break e;
      }
    }
    return z;
  ...
  function E(x, z) {
    ...
    try {
      ...
      if (m !== null) var qn = !0;
        ...
        var ht = n(c);
        (ht !== null && yl(v, ht.startTime - z), (qn = !1));
      }
      return qn;
    } finally {
      ((m = null), (p = T), (g = !1));
...
function vs() {
  if (Qt) {
    var e = Qt,
      t = Kt;
    if (((Kt = Qt = null), Hi(e), t)) for (e = 0; e < t.length; e++) Hi(t[e]);
  }
}
function ys(e, t) {
  return e(t);
...
function Or(e, t) {
  ...
  if (i !== 0) {
    var o = i & ~l;
    o !== 0 ? (r = wn(o)) : ((u &= i), u !== 0 && (r = wn(u)));
  } else ((i = n & ~l), i !== 0 ? (r = wn(i)) : u !== 0 && (r = wn(u)));
  if (r === 0) return 0;
  if (
    t !== 0 &&
    t !== r &&
...
function qu(e, t, n, r) {
  if (Mr) {
    var l = cu(e, t, n, r);
    if (l === null) (Ml(e, t, r, Dr, n), Ki(e, r));
    else if (bc(l, e, t, n, r)) r.stopPropagation();
    else if ((Ki(e, r), t & 4 && -1 < qc.indexOf(e))) {
      for (; l !== null; ) {
        var u = Zn(l);
        if (
          (u !== null && zs(u),
...
var Dr = null;
function cu(e, t, n, r) {
  if (((Dr = null), (e = Gu(r)), (e = wt(e)), e !== null))
...
var Pf = We && "TextEvent" in window && !xn,
  Ds = We && (!ni || (xn && 8 < xn && 11 >= xn)),
  qi = " ",
  bi = !1;
function Is(e, t) {
  switch (e) {
...
function Tf(e, t) {
  if (Mt)
    return e === "compositionend" || (!ni && Is(e, t))
      ? ((e = Ms()), (kr = bu = et = null), (Mt = !1), e)
      : null;
  switch (e) {
    case "paste":
      return null;
...
function As(e) {
  if (e.propertyName === "value" && rl(In)) {
    var t = [];
    (Us(t, In, e, Gu(e)), ws(jf, t));
  }
}
function Of(e, t, n) {
  e === "focusin"
    ? (no(), (Cn = t), (In = n), Cn.attachEvent("onpropertychange", As))
    : e === "focusout" && no();
}
function Mf(e) {
...
function so(e, t, n, r, l) {
  for (var u = t._reactName, i = []; n !== null && n !== r; ) {
    ...
    (o.tag === 5 &&
      ...
      ((o = c),
      l
        ? ((s = Rn(n, u)), s != null && i.unshift($n(n, s, o)))
        : l || ((s = Rn(n, u)), s != null && i.push($n(n, s, o)))),
      (n = n.return));
  }
...
function mt() {
  if (!Il && Ae !== null) {
    ...
    try {
      ...
      throw (Ae !== null && (Ae = Ae.slice(e + 1)), xs(Xu, mt), l);
    } finally {
      ((O = t), (Il = !1));
    }
  }
...
function vi(e, t, n, r, l, u) {
  if (
    ...
    (t.updateQueue = null),
    (t.lanes = 0),
    (xr.current = e === null || e.memoizedState === null ? nd : rd),
    (e = n(r, l)),
    Nn)
  ) {
    u = 0;
...
function $l(e) {
  ...
  if (((e = n.interleaved), e !== null)) {
    l = e;
    do ((u = l.lane), (A.lanes |= u), (Pt |= u), (l = l.next));
    while (l !== e);
...
var Yr = {
  ...
  nd = {
    ...
    useSyncExternalStore: function (e, t, n) {
      ...
      return (
        (l.queue = u),
        So(fa.bind(null, r, u, e), [e]),
        (r.flags |= 2048),
        Qn(9, ca.bind(null, r, u, n, t), void 0, null),
        n
      );
    },
    useId: function () {
  ...
  return (
    ...
    e !== null && !ce
      ? ((t.updateQueue = e.updateQueue),
        ...
        (e.lanes &= ~l),
        Ye(e, t, l))
      : (U && n && li(t), (t.flags |= 1), ue(e, t, r, l), t.child)
  );
}
  ...
  return (
    ...
    e !== null && !ce
      ? ((t.updateQueue = e.updateQueue),
        ...
        (e.lanes &= ~l),
        Ye(e, t, l))
      : (U && r && li(t), (t.flags |= 1), ue(e, t, n, l), t.child)
  );
}
function To(e, t, n, r, l) {
  ...
  if ((Gt(t, l), t.stateNode === null))
    (_r(e, t), Na(t, n, r), xu(t, n, r, l), (r = !0));
  else if (e === null) {
    var i = t.stateNode,
      o = t.memoizedProps;
    i.props = o;
...
function Nu(e, t, n, r, l, u) {
  ...
  return (
    (t.flags |= 1),
    e !== null && i
      ? ((t.child = bt(t, e.child, null, u)), (t.child = bt(t, null, o, u)))
      : ue(e, t, o, u),
...
function Lo(e, t, n, r, l) {
  return (qt(), ii(l), (t.flags |= 256), ue(e, t, n, r), t.child);
}
...
function Oa(e, t, n) {
  ...
  if (u) {
    ...
    return (
      ...
      o !== null ? (u = at(o, u)) : ((u = xt(u, i, n, null)), (u.flags |= 2)),
      (u.return = t),
      (r.return = t),
      (r.sibling = u),
      (t.child = r),
...
function od(e, t, n, r, l, u, i) {
  if (n)
    return t.flags & 256
      ? ((t.flags &= -257), (r = Vl(Error(y(422)))), pr(e, t, i, r))
      : t.memoizedState !== null
  ...
  if (((o = (i & e.childLanes) !== 0), ce || o)) {
    ...
    return (Ni(), (r = Vl(Error(y(421)))), pr(e, t, i, r));
  }
  return l.data === "$?"
    ? ((t.flags |= 128),
      (t.child = e.child),
...
function ad(e, t, n) {
  ...
  switch ((ui(t), t.tag)) {
    ...
    case 17:
      return (de(t.type) && Ur(), ne(t), null);
    case 19:
      if ((I($), (u = t.memoizedState), u === null)) return (ne(t), null);
      if (((r = (t.flags & 128) !== 0), (i = u.rendering), i === null))
        if (r) hn(u, !1);
          ...
          u.tail !== null &&
            Q() > nn &&
            ((t.flags |= 128), (r = !0), hn(u, !1), (t.lanes = 4194304));
        }
      else {
        if (!r)
          if (((e = Qr(i)), e !== null)) {
...
function Ua(e) {
  ...
  (t !== null && ((e.alternate = null), Ua(t)),
    ...
    e.tag === 5 &&
      ((t = e.stateNode),
      t !== null &&
        (delete t[Ie], delete t[An], delete t[yu], delete t[Gf], delete t[Xf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function Ba(e, t, n) {
  for (var r = (e.mode & 1) !== 0; S !== null; ) {
    ...
    if (l.tag === 22 && r) {
      ...
      l.subtreeFlags & 8772 && u !== null ? ((u.return = l), (S = u)) : Do(e);
  }
}
function Do(e) {
  for (; S !== null; ) {
...
function Ha(e, t) {
  ...
  if (t !== 0) {
    if (
      ...
      throw ((n = Kn), Et(e, 0), be(e, r), pe(e, Q()), n);
    if (t === 6) be(e, r);
    else {
      if (
      ...
      switch (((e.finishedWork = l), (e.finishedLanes = r), t)) {
        ...
        case 3:
          if (
            (be(e, r), (r & 130023424) === r && ((t = xi + 500 - Q()), 10 < t))
          ) {
            if (Or(e, 0) !== 0) break;
...
function Xt() {
  if (tt !== null) {
    var e = Ps(Zr),
      ...
      n = O;
    try {
      if (((xe.transition = null), (O = 16 > e ? 16 : e), tt === null))
        var r = !1;
      else {
  ...
  switch (((t.lanes = 0), t.tag)) {
      ...
      return (
        ...
        l.$$typeof === void 0
          ? ((t.tag = 1),
            ...
            xu(t, r, e, n),
            (t = Nu(null, t, r, !0, u, n)))
          : ((t.tag = 0), U && u && li(t), ue(null, t, l, n), (t = t.child)),
        t
      );
    case 16:
      r = t.elementType;
      ...
      e: {
        ...
        if (((r = i.element), u.isDehydrated))
          if (
            ...
            ((l = tn(Error(y(423)), t)), (t = Lo(e, t, r, n, l)));
            break e;
          } else if (r !== l) {
            ((l = tn(Error(y(424)), t)), (t = Lo(e, t, r, n, l)));
            break e;
          } else
            for (
    ...
    case 4:
      return (
        di(t, t.stateNode.containerInfo),
        (r = t.pendingProps),
        e === null ? (t.child = bt(t, null, r, n)) : ue(e, t, r, n),
        t.child
      );
    case 11:
      return (
...
function zr(e, t, n, r, l, u) {
  ...
  if (((r = e), typeof e == "function")) Pi(e) && (i = 1);
    ...
    e: switch (e) {
      ...
      case Gl:
        return ((e = Ee(13, n, t, l)), (e.elementType = Gl), (e.lanes = u), e);
      case Xl:
  ...
  switch (e.tag) {
    case 3:
      ...
      if (t.current.memoizedState.isDehydrated) {
        ...
        n !== 0 &&
          (Zu(t, n | 1), pe(t, Q()), !(R & 6) && ((nn = Q() + 500), mt()));
      }
      break;
    case 13:
      (zt(function () {
...
ys = Ci;
gs = zt;
var zd = { usingClientEntryPoint: !1, Events: [Zn, Ft, ul, hs, vs, Ci] },
  vn = {
...
ge.hydrateRoot = function (e, t, n) {
  ...
  if (
    ...
    (t = qa(t, null, e, 1, n ?? null, l, !1, u, i)),
    (e[Qe] = t.current),
    Un(e),
    r)
  )
...
function jd() {
  return C.jsx("header", {
    ...
    children: C.jsxs("div", {
      ...
      children: [
        C.jsx("div", { className: "logo", children: "TADC Cosplay" }),
        C.jsxs("nav", {
          className: "nav",
          children: [
            C.jsx("a", { href: "#home", children: "Home" }),
            C.jsx("a", { href: "#characters", children: "Characters" }),
            C.jsx("a", { href: "#gallery", children: "Gallery" }),
      ...
      C.jsxs("div", {
        ...
        children: [
          C.jsx("h1", {
            ...
            children: "Welcome to the Digital Circus"
          }),
          C.jsx("p", {
            className: "hero-subtitle",
            children:
              "A portfolio showcasing our cosplay group bringing the surreal world of The Amazing Digital Circus to life."
          }),
          C.jsx("a", {
            href: "#characters",
            className: "hero-cta",
            children: "Meet the Troupe"
          })
        ]
      }),
      C.jsx("div", { className: "hero-overlay" })
    ]
  });
}
const Od = [
  {
    id: "pomni",
    name: "Pomni",
    cosplayer: ["Kohi Berry"],
    description:
      "The newest arrival, bringing chaotic jester energy to life with vibrant red and blue.",
    color: "#ef372c"
  },
  {
    id: "ragatha",
    name: "Ragatha",
    cosplayer: ["Noir Freitag"],
    description: "The kind rag doll, stitched together with love and patience.",
    color: "#f54779"
  },
  {
    id: "jax",
    ...
    cosplayer: ["Moi"],
    description:
      "The sarcastic purple rabbit, capturing his tall, lanky, and mischievous charm.",
    color: "#bd96bf"
  },
  {
    id: "gangle",
    name: "Gangle",
    cosplayer: ["Moogi Dayo"],
    description:
      "A living ribbon of comedy and tragedy, shifting between masks.",
    color: "#7c000c"
  },
  {
    id: "kinger",
    name: "Kinger",
    cosplayer: ["Ian Virgil Ramos"],
    description:
      "The king of the chess board, complete with googly eyes and constant trembling.",
    color: "#6d005e"
  },
  {
    id: "zooble",
    name: "Zooble",
    cosplayer: ["Cess Beltran", "Yanna Mukurose"],
    description:
      "An abstract mix-and-match being, assembled from mismatched parts.",
    color: "#f62681"
  },
  {
    id: "disappearingguy",
    ...
    cosplayer: ["ArJay Em"],
    description:
      "A red wooden NPC in a cowboy hat, that keeps disappearing when he talks. ",
    color: "#ff003d"
  },
  {
    id: "caine",
    name: "Caine",
    cosplayer: ["Uno Tumangan Ramos"],
    description:
      "The wacky, reality-warping AI ringmaster who forces trapped human inhabitants into eccentric, often traumatizing adventures to preserve their sanity, despite completely lacking a true understanding of human emotion.",
    color: "#d8270a"
  }
];
function Md({ character: e, theme: t }) {
  return C.jsxs("div", {
    ...
    children: [
      C.jsx("div", {
        ...
        style: { backgroundColor: e.color + "20", aspectRatio: "3:4" },
        children: C.jsx("img", {
          src: `/characters/headshots/${t}/${e.id}.png`,
          alt: e.id
        })
      }),
      C.jsxs("div", {
        ...
        children: [
          ...
          C.jsx("span", {
            ...
            children: e.cosplayer[t] ? e.cosplayer[t] : e.cosplayer
          }),
...
const Dd = [{ name: "Circus" }, { name: "Noir" }];
function Id() {
      ...
      children: [
        ...
        C.jsx("select", {
          ...
          children: Dd.map((n, r) =>
            C.jsx(
              "option",
              { selected: r === e, value: r, children: n.name },
              `${r}-${n.name}`
            )
          )
        }),
        C.jsx("div", {
          ...
          children: Od.map((n) => C.jsx(Md, { character: n, theme: e }, n.id))
        })
      ]
    })
  });
...
const Fd = [
  { id: 1, title: "Group Shot", images: ["/characters/groups/group.png"] },
  {
    id: 2,
    title: "Pomni, Jax & Ragatha",
    images: ["/characters/groups/trio-1.png"]
  },
  {
    id: 3,
    title: "Caine, Disappearing Guy & Kinger",
    images: ["/characters/groups/trio-2.png"]
  },
  { id: 4, title: "Gangle & Zooble", images: ["/characters/groups/duo-1.png"] },
  { id: 5, title: "Kinger & Pomni", images: ["/characters/groups/duo-a1.png"] },
  {
    id: 6,
    title: "Kinger & Ragatha",
    images: ["/characters/groups/duo-a2.png"]
  },
  {
    id: 7,
    title: "Kinger & Zooble",
    images: ["/characters/groups/duo-a3.png"]
  },
  { id: 8, title: "Kinger & Gangle", images: ["/characters/groups/duo-a4.png"] }
];
function Ud() {
  return C.jsx("section", {
    id: "gallery",
    ...
    children: C.jsxs("div", {
      className: "container",
      children: [
        C.jsx("h2", { className: "section-title", children: "Gallery" }),
        C.jsx("div", {
              ...
              "div",
              {
                ...
                children: [
                  ...
                  C.jsx("div", {
                    ...
                    children: C.jsx("span", { children: e.title })
                  }),
                  C.jsx("div", {
      ...
      C.jsxs("div", {
        ...
        children: [
          C.jsxs("div", {
            ...
            children: [
              C.jsx("h3", { children: "TADC Cosplay" }),
              C.jsx("p", {
                children:
                  "Bringing the digital world to reality, one costume at a time."
              })
            ]
          }),
          C.jsxs("div", {
            ...
            children: [
              C.jsx("h4", { children: "Connect" }),
              C.jsx("span", { children: "Website Creator (ArJay Em)" }),
              C.jsxs("div", {
                className: "social-links",
                style: { display: "flex" },
                children: [
                  C.jsx("a", {
                    href: "https://www.instagram.com/arjay__em",
                    target: "_blank",
                    children: "Instagram"
                  }),
                  C.jsx("a", {
                    href: "https://www.tiktok.com/@arjayem.cos",
                    target: "_blank",
                    children: "TikTok"
                  }),
                  C.jsx("a", {
                    href: "https://www.facebook.com/arjayem.cos",
                    target: "_blank",
                    children: "Facebook"
                  })
                ]
      ...
      C.jsx("div", {
        ...
        children: C.jsxs("p", {
          children: [
            ...
            " TADC Cosplay Group. All rights reserved."
          ]
        })
      })
    ]
...
function Ad() {
  return C.jsxs("div", {
    ...
    children: [
      C.jsx(jd, {}),
      C.jsxs("main", {
        children: [C.jsx(Rd, {}), C.jsx(Id, {}), C.jsx(Ud, {})]
      }),
      C.jsx($d, {})
    ]
  });
...
Ql.createRoot(document.getElementById("root")).render(
  C.jsx(gc.StrictMode, { children: C.jsx(Ad, {}) })
);
